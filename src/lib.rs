// src/lib.rs
/*
 * Core library for GithubActions
 */
...
#[derive(Debug)]
pub struct GithubActionsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GithubActionsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GithubActions processing");
    
    let mut processor = GithubActionsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GithubActionsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GithubActionsProcessor::new(false);
